...
(function () {
  ...
  module.exports = {
    ...
    getIfaceState: function () {
      ...
      l = 0
      // interfaceState = {};
      connectionData = this.execSync("chcp 65001&netsh " + this.WiFiControlSettings.iface + " show interface");
    ...
    connectToAP: function (_ap, adapter) {
      ...
      try {
        ...
        error = error1;
        _msg = "Encountered an error connecting to AP: " + error + ". Write in the home dir";
        this.WiFiLog(_msg, true);
        try {
      ...
      COMMANDS = {
        loadProfile: isWritable ?
          "netsh " + this.WiFiControlSettings.iface + " add profile filename=\"" + _ap.ssid + ".xml\""
          :
          "netsh " + this.WiFiControlSettings.iface + " add profile filename=\"" + `${require('os').homedir}\\${_ap.ssid}` + ".xml\"",
      ...
      return this.execSync(isWritable ? "del \".\\" + _ap.ssid + ".xml\""
        : "del \"" + `${require('os').homedir}\\${_ap.ssid}` + ".xml\"")
    },
