  ...
  module.exports = {
    ...
    getIfaceState: function () {
      ...
      for (k = j = 0, len = ref.length; j < len; k = ++j) {
        ...
        switch (KEY) {
          ...
          case "State":
            if (driver) {
              if (driver.includes("USB") && interfaceState.connection === undefined) {
          ...
          case "SSID":
            if (driver) {
              if (driver.includes("USB") && interfaceState.ssid === undefined) {
    ...
    connectToAP: function (_ap) {
      ...
      COMMANDS = {
        ...
        connect: "netsh " + this.WiFiControlSettings.iface + " connect ssid=\"" + _ap.ssid + "\" name=\"" + _ap.ssid + "\" interface=\"" + this.WiFiControlSettings.adapter + "\""
      };
    ...
    resetWiFi: function () {
      ...
      COMMANDS = {
        disconnect: "netsh " + this.WiFiControlSettings.iface + " disconnect interface=\"" + this.WiFiControlSettings.adapter + "\""
      };
