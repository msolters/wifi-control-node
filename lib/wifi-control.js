...
(function() {
  ...
  module.exports = {
    ...
    scanForWiFi: function() {
      var KEY, VALUE, _msg, _network, c, error, error1, j, k, l, len, len1, ln, networks, nwk, ref, ref1, ref2, scanRequest, scanResults;
        ...
        if (process.platform === "linux") {
          ...
          for (c = j = 0, len = ref.length; j < len; c = ++j) {
            ...
            for (k = l = 0, len1 = ref1.length; l < len1; k = ++l) {
              ln = ref1[k];
              ref2 = parsePatterns.nmcli_line.exec(ln.trim()), KEY = ref2[0], VALUE = ref2[1];
              switch (KEY) {
                case "SSID":
    ...
    connectToAP: function(_ap) {
      var COMMANDS, _msg, com, connectToAPChain, error, error1, error2, i, j, l, len, ref, ssidExist, ssid_hex, stdout, xmlContent, xmlWriteRequest;
      if (WiFiControlSettings.iface == null) {
    ...
    isConnected: function() {
      var _msg, connectionData, error, error1, i, j, len, ln, ref, results;
      try {
        switch (process.platform) {
          case "linux":
