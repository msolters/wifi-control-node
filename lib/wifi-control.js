...
(function() {
  ...
  module.exports = {
    ...
    connectToAP: function(_ap) {
      var COMMANDS, _msg, com, connectToAPChain, error, error1, error2, error3, error4, i, ifaceState, j, k, len, ref, ssid, ssidExist, stdout, xmlContent;
      ...
      try {
        ...
        for (k = 0, len = connectToAPChain.length; k < len; k++) {
          com = connectToAPChain[k];
