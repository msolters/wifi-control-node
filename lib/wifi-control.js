...
(function() {
  var WiFiScanner, events, execSyncToBuffer, os_instructions, private_context;
        ...
        check_iface = (function(_this) {
          return function(_ap) {
            ...
            if (ifaceState.success) {
              ...
              _this.events.emit('connect-to-ap', connect_to_ap_result);
              return;
            }
            if ((new Date() - t0) < private_context.WiFiControlSettings.connectionTimeout) {
              return setTimeout(function() {
                return check_iface(_ap);
              }, 250);
            } else {
              return _this.events.emit('connect-to-ap', {
                success: false,
