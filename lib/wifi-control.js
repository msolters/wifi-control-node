...
(function() {
  ...
  module.exports = {
    ...
    connectToAP: function(_ap, adpater, cb) {
      ...
      try {
        ...
        os_instructions.connectToAP.call(CXT, _ap, adpater);
        ...
        check_iface = (function(_this) {
          return function(_ap, cb) {
            var connect_to_ap_result, ifaceStates, ifaceState;
            ifaceStates = _this.getIfaceState();
            ifaceState = ifaceStates.find(interface => interface.adapterName === adpater)
            if (ifaceStates.success && ((ifaceState.connection === "connected") || (ifaceState.connection === "disconnected"))) {
    ...
    resetWiFi: function(adpater ,cb) {
      var _msg, check_iface, error, error1, t0;
      try {
        os_instructions.resetWiFi.call(CXT, adpater);
