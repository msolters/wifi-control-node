...
(function() {
  ...
  module.exports = {
    ...
    getIfaceState: function() {
      var KEY, VALUE, _msg, connectionData, connectionName, error, error1, error2, error3, error4, error5, foundInterface, interfaceState, j, k, l, len, len1, len2, ln, m, parsedLine, ref, ref1, ref2, ssidData;
      try {
        interfaceState = {};
        switch (process.platform) {
          case "linux":
            ...
            for (k = j = 0, len = ref.length; j < len; k = ++j) {
              ...
              switch (KEY) {
                ...
                case "CONNECTION":
                  if (foundInterface) {
                    connectionName = VALUE.replace(/(["\s'$`\\])/g, '\\$1');
                  }
              }
